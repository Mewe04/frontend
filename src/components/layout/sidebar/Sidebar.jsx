...
const Sidebar = () => {
  return (
    <div className="fixed left-0 top-0 flex flex-col items-center lg:items-start bg-[#1C2434] w-[72px] h-full py-6 px-[12px] lg:py-9 lg:px-5 lg:w-72">
      <img src={fullLogo} alt="Семья: Сопровождение" className="hidden lg:block" />
      ...
      <div className="flex items-center gap-4 mt-4">
        ...
        <span className="hidden lg:block font-medium text-xl text-white uppercase">Username</span>
      </div>
      <nav className="mt-7 h-full">
        <ul>
          {links.map((link) => (
